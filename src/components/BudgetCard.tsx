...
export default function BudgetCard({ name, amount, max, gray }: BudgetCardProps) {
  const classNames = [];
  if(amount > max) {
  ...
  return (
    <Card className={classNames.join(" ")}>
      <Card.Body>
        <Card.Title className="d-flex justify-content-between align-items-baseline fw-normal md-3">
